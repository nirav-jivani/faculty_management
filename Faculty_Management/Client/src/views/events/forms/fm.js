...
const WorkshopForm = (props) => {
    ...
    return (
        <>
            ...
            <br />
            <br />
            <TextField fullWidth label="Topic of the programme" name="title" value={data.title} onChange={handleOnChange} />
            <br />
            <br />
            <br />
            <TextField fullWidth label="Name of the Speaker" name="factName" value={data.factName} onChange={handleOnChange} />
            <br />
            <br />
            <br />
            ...
            <br />
            <FormControl component="fieldset">
                <FormLabel component="legend">Level of programme</FormLabel>
                <RadioGroup aria-label="type" name="type" value={data.type} onChange={handleOnChange}>
